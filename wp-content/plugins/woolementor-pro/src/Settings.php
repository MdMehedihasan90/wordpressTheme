...
class Settings extends Base {
	...
	public function license_form( $section ) {
		...
		echo '<p>' . __( 'Woolementor Pro brings some great features that will blow your mind. And, you need to activate your license to enjoy those features. Please input your license key and click the <strong>Activate</strong> button.', 'woolementor-pro' ) . '</p>';
