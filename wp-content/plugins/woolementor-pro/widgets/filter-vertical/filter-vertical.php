...
class Filter_Vertical extends Widget_Base {
		...
		<div class="wl-fv-filters-area">
			...
			<form method="get" action="<?php echo esc_html( $action ) ?>">
				<div class="wl-fv-filters">
					...
					<?php if( 'yes' == $fv_price_by_show_hide ): ?>
					...
					<?php if( 'yes' == $fv_sort_by_show_hide ): ?>
						<div class="wl-fv-single-filter wl-fv-single-filter-<?php echo $section_id; ?>">
	...
	protected function render_script() {
		...
		<script type="text/javascript">
			jQuery(function($){
				var min_price = parseInt( WOLEMENTOR.min_price )
				var max_price = parseInt( WOLEMENTOR.max_price )
				$( ".wl-fv-range-bar" ).slider({
					range: true,
					min: min_price,
					max: max_price,
					values: [ WOLEMENTOR.crnt_min, WOLEMENTOR.crnt_max ],
