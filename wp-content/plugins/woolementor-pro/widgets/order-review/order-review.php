...
class Order_Review extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Table Headings', 'woolementor-pro' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
		    ...
		    [
		        'label' 		=> __( 'Product Column Heading', 'woolementor-pro' ),
		        'type' 			=> Controls_Manager::TEXT,
		...
		$this->add_control(
		    ...
		    [
		        'label' 		=> __( 'Price Column Heading', 'woolementor-pro' ),
		        'type' 			=> Controls_Manager::TEXT,
		...
		$this->add_group_control(
		    ...
		    [
		        ...
		        'selector'  => '{{WRAPPER}} .wl-order-review table tr td,
		...
		$this->add_group_control(
			...
			[
				...
				'label' 	=> __( 'Typography', 'woolementor-pro' ),
				'scheme' 	=> Scheme_Typography::TYPOGRAPHY_3,
				'selector' 	=> '{{WRAPPER}} .wl-order-review tfoot tr td,
	...
	protected function render() {
		...
		<div class="wl-order-review">
			<?php include plugin_dir_path( __FILE__ ).'/template-parts/review-order.php'; ?>
		</div>
