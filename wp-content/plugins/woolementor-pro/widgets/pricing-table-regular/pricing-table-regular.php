...
class Pricing_Table_Regular extends Widget_Base {
	...
	protected function _register_controls() {
        ...
        */ 
        ...
        $this->add_control(
            ...
            [
                ...
                'type'          => Controls_Manager::TEXT,
                'label_block'   => true,
                'default'       => __( 'Regular Plan', 'woolementor-pro' ),
            ]
        );
        ...
        */
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Content Area', 'woolementor-pro' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
	...
	protected function render() {
        ...
        <div class="wl-pricing-table-regular <?php echo $pt_featured; ?>">
            ...
            <div class="wl-ptr-pricing-area">
                <div class="wl-ptr-price-area">
                    <?php if( 'left' == $pricing_table_currency_alignment ): ?>
                        <div class="wl-ptr-regular-price <?php echo $sale_price_on; ?>">
                        ...
                        <?php endif; ?>
                    <?php elseif( 'right' == $pricing_table_currency_alignment ): ?>
                        <div class="wl-ptr-regular-price <?php echo $sale_price_on; ?>">
                            <?php 
                                echo $del_start; 
                                printf( '<span %s>%s</span>',
                ...
                <ul class="wl-ptr-feature-list">                   
                    ...
                    if( count( $pricing_table_features ) > 0 ): 
                            foreach ($pricing_table_features as $key => $feature):
                                $styling .= ".wl-ptrf-icon-{$feature['_id']}{color: {$feature['icon_color']}} .wl-pricing-table-regular:hover .wl-ptrf-icon-{$feature['_id']}{color: {$feature['icon_hover_color']}}";
                        ?>
                        <li class="wl-ptr-featute">
                            <span class="wl-ptrf-icon wl-ptrf-icon-<?php echo $feature['_id'] ?>"><i class="<?php echo esc_attr( $feature['pricing_table_features_icon']['value'] ); ?>"></i></span>
