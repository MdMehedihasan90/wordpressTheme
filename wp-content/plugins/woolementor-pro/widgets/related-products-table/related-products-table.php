...
class Related_Products_Table extends Widget_Base {
	...
	protected function render() {
        ...
        <div class="wl-rpt-table-div">
            ...
            <?php if ('top-btm-header' == $table_header && $related_product_count > 0 ) : ?>
            <tfoot>
                <tr>
                    <?php $this->render_table_heading(); ?>
                </tr> 
