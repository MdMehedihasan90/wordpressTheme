										...
										<div class="wl-sa-accordion-content-inner">
											...
											<div class="wl-sa-acordion-right">
												<div class="wl-sa-accordion-category">
													...
													<?php if ( 'yes' == $product_tag_show_hide ): ?>
														<?php 
	...
	protected function render_script() {
		...
		<script>
			jQuery(function($) {
				...
				// $('.wl-sa-accordion-area .wl-sa-accordion-content').hide()
				// $('.wl-sa-accordion-area .wl-sa-open .wl-sa-accordion-content').show()

				$('.wl-sa-accordion-title').off().on('click', function(){
					var id = $(this).data('id')

					// $(this).parents('.wl-sa-accordion-area').find('.wl-sa-accordion-content').slideUp()
					$(this).parents('.wl-sa-accordion-area').find('.wl-sa-accordion-content').parent().removeClass('wl-sa-open')

					// alert('yes')

					// $(this).next('.wl-sa-accordion-content').slideDown()

					// $(this).next().parent().toggleClass('wl-sa-open')
					// $(this).parent().toggleClass('wl-sa-open')

					// $('.wl-sa-single-accordion').removeClass('wl-sa-open')

					$('#wl-sa-single-accordion-' + id).toggleClass('wl-sa-open')

					// var open = $(this).parent().hasClass("wl-sa-open")
					// if( open ){
					// 	$('.wl-sa-single-accordion').removeClass('wl-sa-open')
					// }
					// else{
					// 	$('.wl-sa-single-accordion').addClass('wl-sa-open')
					// }

					// $(this).next().parent().toggleClass(function() {
					//   if ( $( this ).parent().is( ".wl-sa-open" ) ) {
					//     alert('yes')
					//     $(this).next().parent().removeClass('wl-sa-open')
					//   } else {
					//    alert('no')
					//     $(this).next().parent().addClass('wl-sa-open')
					//   }
					// });
				...
				// 	var links = this.el.find('.wl-sa-item');
				// 	links.on('click', {
				// 		el: this.el,
				...
				// 	if (!e.data.multiple) {
				// 		$el.find('.wl-sa-item-data').not($next).slideUp().parent().removeClass('wl-sa-open');
				// 	};
				// }
				// var accordion = new Accordion($('.wl-sa-single-accordion'), false);
