...
class Shop_Table extends Widget_Base {
            ...
            <div style="overflow-x:auto;">
                ...
                if( $products->have_posts() ) : 
                    ...
                    <tr>
                        ...
                        <?php 
                        if ( !empty( $id_visibility ) ) {
                            printf( '<td class="wl-st-td %s">%d</td>',
                                esc_attr(  implode( ' ', $id_visibility ) ),
                                esc_html( $product_id )
                            );
                        }
                        ?>

                        <td class="wl-st-td wl-st-img <?php echo implode( ' ', $image_visibility ); ?>"> 
                        ...
                        <td class="wl-st-td wl-st-name <?php echo implode( ' ', $title_visibility ); ?>"> <?php echo $product->get_name(); ?> 
                        ...
                        <?php 
                            ...
                            if ( !empty( $category_visibility ) ) {
                                printf( '<td class="wl-st-td %s">%s</td>',
                                    esc_attr( implode( ' ', $category_visibility ) ),
                                    wc_get_product_category_list( $product_id )
                                );
                            }

                            if ( !empty( $short_desc_visibility ) ) {
                                printf( '<td class="wl-st-td %s">%s</td>',
                                    esc_attr( implode( ' ', $short_desc_visibility ) ),
                                    wpautop( $product->get_short_description() )
                                );
                            }

                            if ( !empty( $price_visibility ) ) {
                                printf( '<td class="wl-st-td %s">%s</td>',
                                    esc_attr( implode( ' ', $price_visibility ) ),
                                    $product->get_price_html()
                                );
                            }
                        ?>

                        <td class="wl-st-td <?php echo implode( ' ', $action_visibility ); ?>"> 
    ...
    private function render_editing_attributes() {
        ...
        $id_class           = implode( ' ', $id_visibility );
        $img_class          = implode( ' ', $image_visibility );
        $title_class        = implode( ' ', $title_visibility );
        $category_class     = implode( ' ', $category_visibility );
        $desc_class         = implode( ' ', $short_desc_visibility );
        $price_class        = implode( ' ', $price_visibility );
        $action_class       = implode( ' ', $action_visibility );
