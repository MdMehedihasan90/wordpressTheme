<?php
/**
 * Plugin Name: Woolementor Pro
 * Description: Premium feature unlocker for <strong>Woolementor</strong>.
...
final class Plugin {
	...
	public function define() {
		...
		define( 'WOOLEMENTOR_PRO_DEBUG', apply_filters( 'woolementor-pro-debug', false ) );
		...
		$this->plugin['depends']	= [ 'woolementor/woolementor.php' => 'Woolementor' ];
		$this->plugin['license']	= new License( $this->plugin, 'admin.php?page=woolementor#woolementor_license' );
	}
