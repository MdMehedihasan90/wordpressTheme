...
class Settings extends Base {
	...
	public function tools_content( $section )	{
		...
		?>
			...
			<div class="cxrow">
				<div class="cx-label-wrap"><label for="wooffiliate_advanced-ref_key"><?php _e( 'Reset', 'woolementor' ) ?></label></div>
			...
			<div class="cxrow">
				<div class="cx-label-wrap"><label for="wooffiliate_advanced-ref_key"><?php _e( 'Report', 'woolementor' ) ?></label></div>
